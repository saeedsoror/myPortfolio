    ...
    return(
        ...
        {/* <div className="theCardsAbout"> */}
            ...
            <div className="aboutBox" id="aboutBox">
                {/* <div className="frontendAndPhoto"> */}
                {/* </div> */}
                {/* <div className="allInsideAboutBox"> */}

                    {/* <div className="linesPer"> */}
                    ...
                    <div className="allInfo">
                        ...
                        <h1 className="frontEndText">Front-End<br /> Developer</h1>
                        </div>
